...
echo " "
echo "Erroneous Example"
echo "python print_fires.py --queryval 'United States of America' --querycol Area --resultcol 'Forest fires' --filename Agrofood_co2_emssion.csv"
...
echo " "
echo "Erroneous Example"
echo "python print_fires.py --queryval 'Datlof' --querycol Area --resultcol 'Forest fires' --filename Agrofood_co2_emission.csv"
