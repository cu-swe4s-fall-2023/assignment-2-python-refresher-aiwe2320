...
forest_fires = my_utils.get_column(file_name = file_name, query_column = country_column, query_value = country, result_column = fires_column)
year_list = my_utils.get_column(file_name = file_name, query_column = country_column, query_value = country, result_column = year_col_name)

if(forest_fires == None):
